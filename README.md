...
## hector_models (noetic) - 0.5.0-1

The packages in the `hector_models` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release hector_models --track noetic --rosdistro noetic --new-track` on `Thu, 17 Dec 2020 18:07:21 -0000`
